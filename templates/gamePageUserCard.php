...
<a href="otherProfile.php?user_id=<?php echo $userId ?>&previous_url=gamePage.php?game_id=<?php echo $gameId; ?>%26previous_url=<?php echo $previousUrl ?>" class="game_card_link">
    <article class="card game_card">
        ...
        <div class="card_buttons">
            ...
            <?php } ?>
            <a href="friendMessage.php?user_id=<?php echo $userId; ?>&previous_url=gamePage.php?game_id=<?php echo $gameId; ?>%26previous_url=<?php echo $previousUrl; ?>" class="msg-bubble"><i class="bi bi-chat-dots"></i></a>
        </div>
    </article>
</a>